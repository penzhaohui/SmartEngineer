...
namespace SmartEngineer.Framework.Constant
{
    public class EmailSettingConstant
    {
        public static readonly string OPTION_NAME = "Email Server Setting";
        public static readonly string DISPLAY_NAME = "Display Name";
        public static readonly string USER_NAME = "User Name";
