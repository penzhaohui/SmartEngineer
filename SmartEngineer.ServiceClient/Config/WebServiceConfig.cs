...
namespace SmartEngineer.Config
{
    ...
    public static class WebServiceConfig
    {
        ...
        public static WebServiceParameter GetWebServiceParameter(string serviceName)
        {
            if (serviceName == null)
            {
                throw new Exception("parameter 'service' isn't allowed to be null.");
            }

            // look for the custom web service config node by web service id(full name)
            WebServiceNode customNode = FindWebServiceNode(serviceName);
            ...
            else
            {
                ...
                result.Url = RebuildUrl(result.Url, serviceName);
            }
        ...
        private static string RebuildUrl(string urlRoot, string serviceName)
        {
