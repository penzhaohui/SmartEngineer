...
//        开源日期:           2013/09/01
//        作者:           何雨泉    
//        博客：          http://www.cnblogs.com/heyuquan/p/net-batch-mail-send-async.html
//        版本:           0.0.0.1
//======================================================================
...
namespace SmartEmail
{
    ...
    /// 3、SmtpClient 没有提供 Finalize() 终结器，所以GC不会进行回收，只能由外部使用完后进行显式释放，否则会发生内存泄露问题
    /// </summary>
    public class SmtpHelper
    {
        ...
        public SmtpHelper AddClientCertificate(X509Certificate certificate)
        {
            ...
            {
                // C# X509Certificate类 调用证书 - https://www.cnblogs.com/cookiebin/p/4688608.html
                string certPath = @"F:\MyWorkspace\SmartEngineer\SmartEngineer.Framework\Encryption\SmartEngineerCA.cer";
                string password = "smartengineer";  //证书密码
